        ...
        <div className="home-container">
          <div className='mask'>
            <div className="carousel">
              ...
              <div className="carousel-image" style={{ backgroundImage: "url('https://www.loginworks.com/wp-content/uploads/2018/01/client-customer-relationship-management-2.jpg')" }}></div>
