    ...
    <div className='hero'>
      <div className="home-container">
        <div className='masks'>
          ...
          <div className="carousel-image" style={{ backgroundImage: "url('https://quasa.io/storage/images/news/cImV8ugwWdC58TF1rgyNTgWh3xY0UxM8hzih6tlv.png')" }}></div>               <div className="carousel-image" style={{ backgroundImage: "url('https://cdn.infodiagram.com/c/c623fc/customer-relationship-management.png')" }}></div>
